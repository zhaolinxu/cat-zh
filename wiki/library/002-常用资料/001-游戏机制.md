...
<p>
在小猫游戏中有四个季节。
就像在现实世界中一样，它们会影响资源生产，特别是影响你的
<a href="?file=003-资源大全/01-猫薄荷">
  猫薄荷
</a>。
从第4年开始（年份从0年开始），季节将有机会比平均温度更暖或更冷，改变你的猫薄荷。
一个季节异常的概率是35%，而变暖或变冷的概率是相同的（也就是说，有17.5％的可能性是温暖的，有17.5％的可能性是冷的，65％的可能性是平均）。
季节只影响猫薄荷田产量;
农民不受影响。
</p>
...
任务命名的，分别是：卡戎，暗影，纱星，太阳，轨道，红月，沙丘，游泳池（碧池），终焉，开罗。
...
<p>
  这些奖金是附加的，例如，研究套牛绳，狩猎盔甲和钢制甲会给你一个3.5的总狩猎奖金。
...
<li>
 ...
 <a href="?file=003-资源大全/19-星图">
  ...
  。
  如果没有手动观察，事件仍然可能自动成功，每个天文台有1％的机会（在钢铁意志模式下有25%的几率）。
</li>
<li>
当先前的天文事件悬而未决时，天文事件仍有可能发生。这将立即超时前面的事件，触发针对自动成功率的检查。
</li>
<li>
  在获得
 <a href="#workshop#SETI">
  ...
  升级后，所有的天文事件都会自动而无声地成功。
</li>
<li>
  天文事件给予（25 +（天文奖励））×（1 +科学奖金）的科学点。
...
<ul>
<li>
  [回溯时空学](?file=001-猫咪百科/03-科技/02-玄学#回溯时空学)：时间晶体和时间物理技术。
</li>
<li>
  拥有[空间转移发生器](?file=001-猫咪百科/01-建筑物/09-超级建筑物#空间转移发生器)：一小部分非制作的资源（猫薄荷，木材，矿物，煤炭，铁，钛，金，石油，铀，难得素，喵力，科学，文化，信仰，星图，反物质，遗物，虚空）。
  这个百分比取决于恢复-停滞比（每个 空间转移发生器 携带1.5％）。
</li>
<li>
  随着 空间转移发生器 和Flux冷凝器的升级：您所拥有的资源越多（木梁，石板，混凝土，金属板，钢材，合金，E合金，齿轮，脚手架，船舶，油轮，羊皮纸，手稿，概要，蓝图，钍和巨石）。
  数量首先平方根并乘以100。然后输入恢复-停滞比。
</li>
<li>
  与冷冻仓：与冷冻室数量一样多的小猫，从最老的小猫开始。
</li>
</ul>
<p>
重置时获得的收益：
