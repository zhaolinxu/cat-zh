...
dojo.declare("classes.managers.ResourceManager", com.nuclearunicorn.core.TabManager, {
	...
	update: function(){
		...
		for (var i in this.resources){
			...
			var challengeEffect = this.game.getLimitedDR(this.addResMaxRatios(res, this.game.getEffect(res.name + "MaxChallenge")), maxValue - 1 - game.bld.effectsBase[res.name +'Max']);
