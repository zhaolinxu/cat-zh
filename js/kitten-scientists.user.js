...
var run = function() {
    ...
    var options = {
        ...
        auto: {
            ...
            craft: {
                ...
                items: {
                    木头:       {require: 'catnip',      max: 0, limited: false, enabled: true},
                    木梁:       {require: 'wood',        max: 0, limited: false, enabled: true},
                    石板:       {require: 'minerals',    max: 0, limited: false, enabled: true},
                    钢:      {require: 'coal',        max: 0, limited: false, enabled: true},
                    金属板:      {require: 'iron',        max: 0, limited: false, enabled: true},
                    合金:      {require: 'titanium',    max: 0, limited: true,  enabled: false},
                    混凝土:   {require: false,         max: 0, limited: true,  enabled: false},
                    齿轮:       {require: false,         max: 0, limited: true,  enabled: false},
                    支架:   {require: false,         max: 0, limited: true,  enabled: false},
                    船:       {require: false,         max: 0, limited: true,  enabled: false},
                    油罐车:     {require: false,         max: 0, limited: true,  enabled: false},
                    羊皮纸:  {require: false,         max: 0, limited: true,  enabled: true},
                    手稿: {require: 'culture',     max: 0, limited: true,  enabled: true},
                    摘要: {require: 'science',     max: 0, limited: true,  enabled: true},
                    蓝图:  {require: 'science',     max: 0, limited: true,  enabled: false},
                    煤油:   {require: 'oil',         max: 0, limited: true,  enabled: false},
                    巨石:   {require: false,         max: 0, limited: true,  enabled: false},
                    钚:    {require: 'unobtainium', max: 0, limited: true,  enabled: false},
                    钍:    {require: 'uranium',     max: 0, limited: true,  enabled: false}
                }
            },
            trade: {
                ...
                items: {
                    龙:    {enabled: false,  require: 'titanium',    allowcapped: false,
                        summer:  true,  autumn:  true,  winter:  true,          spring:      true},

                    斑马:     {enabled: true,  require: false,         allowcapped: false,
                        summer:  true,  autumn:  true,  winter:  true,          spring:      true},

                    蜥蜴:    {enabled: false,  require: 'minerals',    allowcapped: false,
                        summer:  true,  autumn:  false, winter:  false,         spring:      false},

                    鲨鱼:     {enabled: false,  require: 'iron',        allowcapped: false,
                        summer:  false, autumn:  false, winter:  true,          spring:      false},

                    狮鹫:   {enabled: false,  require: 'wood',        allowcapped: false,
                        summer:  false, autumn:  true,  winter:  false,         spring:      false},

                    娜迦:      {enabled: false,  require: false,         allowcapped: false,
                        summer:  false, autumn:  false, winter:  false,         spring:      true},

                    蜘蛛:    {enabled: false,  require: false,         allowcapped: false,
                        summer:  false, autumn:  true,  winter:  false,         spring:      false},

                    巨兽: {enabled: false,  require: 'unobtainium', allowcapped: true,
                        summer:  true,  autumn:  true,  winter:  true,          spring:      true}
                }
            },
            resources: {
    ...
    var getTradeOption = function (name, option) {
        ...
        list.append(getSeason(name, '春', option));
        list.append(getSeason(name, '夏', option));
        list.append(getSeason(name, '秋', option));
        list.append(getSeason(name, '冬', option));
