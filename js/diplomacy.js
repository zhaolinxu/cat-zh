...
dojo.declare("classes.managers.DiplomacyManager", null, {
	...
	tradeImpl: function(race, totalTradeAmount) {
		...
		var boughtResources = {};
		var tradeRatio = 1 + this.game.diplomacy.getTradeRatio() + this.game.diplomacy.calculateTradeBonusFromPolicies(race.name, this.game) + this.game.challenges.getChallenge("pacifism").getTradeRatio(this.game);
...
dojo.declare("com.nuclearunicorn.game.ui.tab.Diplomacy", com.nuclearunicorn.game.ui.tab, {
	...
	render: function(tabContainer){
		...
		for (var i = 0; i < races.length; i++) {
			...
			var tradeRatio = baseTradeRatio + this.game.diplomacy.calculateTradeBonusFromPolicies(race.name, this.game) + this.game.challenges.getChallenge("pacifism").getTradeRatio(this.game);
