    ...
    render: function(container){
        ...
        UIUtils.attachTooltip(this.game, this.timeSpan, 0, 200, dojo.hitch(this, function(){
            ...
            if (this.game.workshop.get("chronoforge").researched) {
                tooltip += "<br>Temporal heat is generated by Time Crystal shattering and decreases over the time. Every 1 unit of heat over the limit will increase Time Crystal shattering price by 1%"
            }
